...
export class VodMapper {
  static toDomain(prismaVod: PrismaVod): Vod {
    return {
      ...
      alignment: ((prismaVod as any).alignment as Record<string, any>) ?? undefined,
      hudSignal: (prismaVod as any).hudSignal ?? undefined,
      signalSampleRate: (prismaVod as any).signalSampleRate ?? undefined,
