...
export interface IClipRepository {
  ...
  update(id: string, data: Partial<Pick<Clip, 'startSeconds' | 'endSeconds' | 'title' | 'roundName' | 'players' | 'score' | 'status' | 'filePath' | 'thumbnailPath' | 'youtubeVideoId'>>): Promise<Clip>;
